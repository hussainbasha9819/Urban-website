...
const Main3 = () => {
  return (
  <div className="w-full phone:flex phone:w-full  phone:h-[80vh] phone:flex-col phone:items-center phone:justify-start   h-screen bg-black flex items-center justify-center ">
    <div className="w-1/2 phone:w-[80%] phone:h-[40vh] phone: h-[60vh] flex   ">
