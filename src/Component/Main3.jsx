...
const Main3 = () => {
  return (
  <div className="w-full phone:flex phone:w-full  phone:h-[85vh] phone:flex-col phone:items-start phone:justify-start   h-screen bg-black flex items-center justify-center ">
    ...
    <div className="w-1/2 phone:w-[80%]   phone:h-[45vh] phone:flex phone:flex-col phone:pt-5 phone:pl-3  phone:gap-0 h-[60vh] flex flex-col pt-9  gap-2 ">
